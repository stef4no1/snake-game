...
# Declaro las funciones y clases
...
def endGame():
    message = game_over_font.render("Perdiste", 1, pygame.Color("white"))
    message_play_again = play_again_font.render("Jugar de nuevo ? (Y/N)", 1, pygame.Color("green"))
